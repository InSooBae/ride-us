...
import com.ssafy.rideus.repository.query.CoordinateBulkRepository;
...
public class RideService {
    ...
    private final CoordinateBulkRepository coordinateBulkRepository;
    ...
    @Transactional
    public void finishRidding(Long memberId, RiddingType riddingType, FinishRiddingRequest request) {
...
//                .orElseThrow(() -> new NotFoundException(RECORD_NOT_FOUND));
        ...
        List<Coordinate> coordinateList = coordinateService.makeCoordinateFromFile(coordinateService.findFile("D:/", memberId + "_" + request.getRideRoomId()));
        // mysql에 최종 기록 저장
...
//
//        return CreateRecordResponse.from(saveRecord.getId());
        coordinateBulkRepository.saveAll(coordinateList, request.getRecordId());
    }
